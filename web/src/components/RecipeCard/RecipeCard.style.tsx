import { Theme, darken, createStyles } from "@material-ui/core/styles";
...
const recipeCardStyle = ({
  ...
  createStyles({
    ...
    actionIcon: ({ isLiked }: StyleProps) => ({
      width: 16,
      height: 16,
      fill: !!isLiked ? palette.error.light : palette.text.secondary,
    }),
  });
...
const useRecipeCardStyle = makeStyles<Theme, StyleProps>(recipeCardStyle, {
  name: "RecipeCard",
});
